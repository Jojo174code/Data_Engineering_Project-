...
BASE = CLEANED_DIR / 'base_900_to_1000_properties.csv'
...
TOP = OUT_DIR / 'top_50_properties_900_to_1000_crime_economic_ai.xlsx'
FULL = OUT_DIR / 'full_ranked_properties_900_to_1000_crime_economic_ai.xlsx'
RISK = OUT_DIR / 'high_risk_removed_properties_900_to_1000.xlsx'
REPORT = LOG_DIR / 'validation_report.txt'
SOURCE_PREFERRED = '/home/ubuntu/OpenClaw_Context/iterations/iteration_09_900_to_1000_ai_ranked/cleaned_data/final_ranked_properties_900_to_1000.csv'
...
def main():
    ...
    assert top['bid_cost'].between(900, 1000).all()
    ...
    report_lines = [
        ...
        f'total properties in $900-$1,000 range: {len(base)}',
